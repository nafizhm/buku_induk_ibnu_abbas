            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Hari Libur Nasional</h3>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-2 ms-1">
                            <fieldset class="form-group">
                                <select name="tahun" class="form-control select-tahun" id="tahun">
                                    <option value=""></option>
                                    @foreach ($tahun as $th)
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title white" id="myModalLabel160">Form Hari Libur Nasional
                    </h5>
                ...
                <div class="modal-body">
                    <form id="formData">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="dalam_rangka" class="col-sm-4 col-form-label">Dalam Rangka</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="dalam_rangka" name="dalam_rangka">
                            </div>
                        </div>
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                searching: true,
                ajax: {
                    url: "{{ route('hari-libur-nasional.index') }}",
                    data: function(d) {
                        d.tahun = $('#tahun').val();
                    }
                },
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.get(url, function(response) {
                if (response.status === 'success') {
                    ...
                    $('#dalam_rangka').val(response.data.dalam_rangka);
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('hari-libur-nasional.update', ['hari_libur_nasional' => ':id']) }}'.replace(
                    ':id',
                    id) :
                '{{ route('hari-libur-nasional.store') }}';
