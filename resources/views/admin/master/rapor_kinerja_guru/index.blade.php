            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-content-center justify-content-between">
                        <h3 class="font-weight-bold text-xl">Soal Rapor Kinerja Guru</h3>
                        <div class="d-flex align-items-center">
                            @if (isset($permissions['tambah']) && $permissions['tambah'] == 1)
                                <a href="{{ route('rapor-kinerja-guru.create') }}" class="btn btn-primary btn-sm"><i
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                ordering: false,
                responsive: true,
                ajax: "{{ route('rapor-kinerja-guru.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
