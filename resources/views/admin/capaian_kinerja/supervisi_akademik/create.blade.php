    ...
    <div class="page-title">
        <div class="row mb-3">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h4>Capaian Supervisi Akademik</h4>
            </div>
        </div>
    </div>
            ...
            <form id="formData">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="submit" class="btn btn-primary" id="submitBtn">
                        ...
                        <span class="button-text">Simpan Supervisi Akademik</span>
                    </button>
                </div>
            </form>
...
@push('scripts')
    <script>
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = '{{ route('capaian-supervisi-akademik.store') }}';
            let method = 'POST';
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    window.location.href = "{{ route('capaian-supervisi-akademik.index') }}";
                },
                error: function(xhr) {
                    if (xhr.status === 422) {
                        audio.play();
                        ...
                        btnText.text('Simpan Supervisi Akademik');
