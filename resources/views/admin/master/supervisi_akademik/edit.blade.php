        ...
        <section class="section">
            <div class="card">
                <div class="card-header bg-primary mb-4 d-flex align-items-center">
                    <h3 class="font-weight-bold text-xl text-white m-0">Edit Soal Supervisi Akademik</h3>
                </div>
                <div class="card-body">
                    <form id="formData">
                        @csrf
...
@push('scripts')
    <script>
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = '{{ route('supervisi-akademik.update', ['supervisi_akademik' => ':id']) }}'.replace(':id',
                id);
            let method = 'PUT';
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    window.location.href = "{{ route('supervisi-akademik.index') }}";
                },
                error: function(xhr) {
                    if (xhr.status === 422) {
                        audio.play();
